...
<sql:query var="reviewResult" dataSource="${data}">
	 select review from review where bookid=(select id from book where bookname=?);
...
<tr>
<th>BOOK ID </th> <th>BOOK NAME </th> <th>BOOK AUTHOR</th> <th>REVIEW</th>
</tr>
		...
		<c:forEach var="row" items="${result.rows}">
			<tr>
				...
				<td>
					...
					<c:forEach var="row1" items="${reviewResult.rows}">
						<tr>
							
							<td><ul><li><c:out value="${row1.review}"/></li></ul></td>
						</tr>				
					</c:forEach>
